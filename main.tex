...
\begin{itemize}
    ...
    \item They assume homogeneity of variances for the errors (homoskedasticity).
...
\paragraph{Homoskedasticity vs Heteroskedasticity}\mbox{} \\ 
\mbox{} \\

\textbf{Homoskedasticity} means that all the residuals of the regression have the same variance.

\includegraphics[width=3cm, height=3cm]{homoscedasticity}

\textbf{Heteroskedasticity} Heteroskedasticity is the violation of the assumption that all the errors of the regression have the same variance.
