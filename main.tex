...
\begin{itemize}
    \item $\bar{x}$ is used for mean over sample.
    \item $\mu$ is used for mean over the entire population.
\end{itemize}
...
Being square rooted, the standard deviation returns a value that has again the same scale of our dataset, hence allowing for better comparisons and understanding. 
...
\subsubsection{Law of Large Numbers}\mbox{} \\
\mbox{} \\
